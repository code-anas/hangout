...
const Groups = props => {
  let arr = [
    ...
    {
      groupName: 'Workout Squad Two',
      colorLayer: '#9D3E9490',
      description:
        'My Nmae is Usman Bhatti.Im developing an app in React Native',
      user: [
        {image: require('../../assets/images/image.png')},
        {image: require('../../assets/images/image.png')},
        {image: require('../../assets/images/image.png')},
    ...
    {
      groupName: 'Workout Squad Three',
      colorLayer: '#2D39A890',
      description:
        'My Nmae is Usman Bhatti.Im developing an app in React Native.I reach my goal ASAP INSHALLAH',
      user: [
        {image: require('../../assets/images/image.png')},
        {image: require('../../assets/images/image.png')},
      ],
  ...
  return (
    <View style={styles.flex1Container}>
      <View style={styles.headerItems}>
        ...
        <TouchableOpacity
          onPress={() => props.navigation.navigate('CreateHangout')}
          style={styles.groupButton}>
          <Text style={styles.txtGroup}>Create Hangout</Text>
